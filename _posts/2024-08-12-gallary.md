...
<div class="offer-box" style="box-shadow: rgba(14, 30, 37, 0.12) 0px 2px 4px 0px, rgba(14, 30, 37, 0.32) 0px 2px 16px 0px;"><br><br>
  <h2 style="align-items:center;">We also Offer Buy Back!!</h2>
  <br><br>
</div>
<!-- <style>
  .offer-box {
  ...
  box-shadow: 0 10px 20px rgba(0, 0, 0, 0.2), 0 6px 6px rgba(0, 0, 0, 0.15); /* Layered shadow */
